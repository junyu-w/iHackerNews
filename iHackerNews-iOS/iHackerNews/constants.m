...
NSString* const serverURL = @"https://fierce-mesa-9720.herokuapp.com/";

NSString* const getUserURL = @"https://fierce-mesa-9720.herokuapp.com/users/id?";
NSString* const createUserURL = @"https://fierce-mesa-9720.herokuapp.com/users";

NSString* const markPostURL = @"https://fierce-mesa-9720.herokuapp.com/mark_post";
NSString* const unmarkPostURL = @"https://fierce-mesa-9720.herokuapp.com/unmark_post";

NSString* const postsOfUserURL = @"https://fierce-mesa-9720.herokuapp.com/posts_of_user";
NSString* const getDifferentDatesOfPostsURL = @"https://fierce-mesa-9720.herokuapp.com/different_dates_of_posts";
